...
def generate_launch_description():
    ...
    pkg_nav_demos = get_package_share_directory('navigation_package')
    ...
    # Lifecycle Node Manager to automatically start lifecycle nodes (from list)
    node_lifecycle_manager = Node(
        package='nav2_lifecycle_manager',
        executable='lifecycle_manager',
        name='lifecycle_manager_navigation',
        output='screen',
        parameters=[config_planner, {'node_names': lifecycle_nodes}],
    )
